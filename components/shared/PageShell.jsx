  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="flex-1 flex flex-col lg:ml-64">
        {/* ════ TOPBAR ════ */}
        <header
          className="h-15 sticky top-0 z-30 flex items-center justify-between px-4 sm:px-6
        ...
        >
          ...
          <div className="flex items-center gap-3">
            ...
            {/* Date pill */}
            <div
              className="hidden sm:flex items-center gap-1.5 bg-white/10 border border-white/20
          ...
          <div className="max-w-[1280px] mx-auto h-[52px] flex items-center justify-between flex-wrap gap-2">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[11.5px] text-gray-400 border-l border-gray-200 pl-2">
                Mirmire Bachat Rin Sahakari Sanstha Ltd.
              </span>
            </div>
            <p className="text-[11.5px] text-gray-400">
              © {new Date().getFullYear()} MirmiraHRMS · 📍 Tokha, Kathmandu
            </p>
          </div>
        </footer>
      </div>
